...
PROMPT_V1_NAME = "lam-minh-duc-rag-v1"   # ví dụ: "nguyen-rag-v1"
PROMPT_V2_NAME = "lam-minh-duc-rag-v2"   # ví dụ: "nguyen-rag-v2"
...
SYSTEM_V1 = (
    ...
    "Giữ câu trả lời ngắn gọn trong 2-4 câu; nếu context không đủ thông tin, hãy nói rõ.\n\n"
    "Context:\n{context}"
)
...
SYSTEM_V2 = (
    "Bạn là chuyên gia AI. Chỉ dùng context sau để trả lời, đọc kỹ và xác định các facts liên quan. "
    "Viết câu trả lời rõ ràng, có cấu trúc, theo giọng điệu chuyên gia trong 3-5 câu. "
    "Nếu context không đủ thông tin, hãy nêu rõ giới hạn.\n\nContext:\n{context}"
)
